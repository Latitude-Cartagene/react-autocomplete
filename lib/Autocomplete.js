...
class Autocomplete extends React.Component {
      ...
      if (!this.isOpen()) {
        ...
        this.setState(
          ...
          () => {
            ...
            this.references.input.setSelectionRange(value.length, value.length);
  ...
  maybeAutoCompleteText() {
    ...
    const matchedItem =
      items[index] && this.props.isItemSelectable(items[index])
        ? items[index]
        : null;
  ...
  renderMenu() {
    ...
    return React.cloneElement(menu, {
      ...
      onTouchMove: () => this.setIgnoreBlur(false),
    ...
    return (
      <div style={{ ...this.props.wrapperStyle }} {...this.props.wrapperProps}>
        <div
          ...
          aria-owns={"lc-autocomplete-" + inputProps.id}
          aria-haspopup="listbox"
          className="lc-combobox"
          aria-labelledby={
            inputProps.id === "inputStart"
              ? `labelInputStart`
              : inputProps.id === "inputEnd"
                ? "labelInputEnd"
                : inputProps.id
          }
        >
          {this.props.renderInput({
            ...
            "aria-controls": "lc-autocomplete-" + inputProps.id,
            "aria-activedescendant": "result-item-" + highlightedIndex,
            autoComplete: "off",
            ref: this.exposeAPI,
